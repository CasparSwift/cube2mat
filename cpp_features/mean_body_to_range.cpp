...
void cube2mat_mean_body_to_range(py::array_t<float, py::array::c_style | py::array::forcecast>& result,
...
void bind_cube2mat_mean_body_to_range(py::module& m) {
    m.def("cube2mat_mean_body_to_range", &cube2mat_mean_body_to_range,
          py::arg("result"), py::arg("cubes_map"),
          "Mean candlestick body-to-range ratio in RTH; exclude zero-range bars.");
}
