...
void cube2mat_rv_cond_below_vwap(py::array_t<float, py::array::c_style | py::array::forcecast>& result,
...
void bind_cube2mat_rv_cond_below_vwap(py::module& m){
    m.def("cube2mat_rv_cond_below_vwap", &cube2mat_rv_cond_below_vwap,
