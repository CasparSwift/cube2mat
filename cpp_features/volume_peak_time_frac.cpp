...
void cube2mat_volume_peak_time_frac(py::array_t<float, py::array::c_style | py::array::forcecast>& result,
...
void bind_cube2mat_volume_peak_time_frac(py::module& m){
    m.def("cube2mat_volume_peak_time_frac", &cube2mat_volume_peak_time_frac,
          py::arg("result"), py::arg("cubes_map"),
          "Fraction of session minutes when per-bar volume peaks.");
}
