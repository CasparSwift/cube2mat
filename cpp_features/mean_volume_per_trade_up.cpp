...
void cube2mat_mean_volume_per_trade_up(py::array_t<float, py::array::c_style | py::array::forcecast>& result,
...
void bind_cube2mat_mean_volume_per_trade_up(py::module& m){
    m.def("cube2mat_mean_volume_per_trade_up", &cube2mat_mean_volume_per_trade_up,
          py::arg("result"), py::arg("cubes_map"),
          "Average interval_volume per trade on up bars");
}
