...
void cube2mat_time_to_20pct_volume_min(py::array_t<float, py::array::c_style | py::array::forcecast>& result,
...
void bind_cube2mat_time_to_20pct_volume_min(py::module& m) {
    m.def("cube2mat_time_to_20pct_volume_min", &cube2mat_time_to_20pct_volume_min,
          py::arg("result"), py::arg("cubes_map"),
          "Absolute minutes required to reach 20% of session volume.");
}
