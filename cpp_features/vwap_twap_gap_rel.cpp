...
void cube2mat_vwap_twap_gap_rel(py::array_t<float, py::array::c_style | py::array::forcecast>& result,
...
void bind_cube2mat_vwap_twap_gap_rel(py::module& m){
    m.def("cube2mat_vwap_twap_gap_rel", &cube2mat_vwap_twap_gap_rel,
          py::arg("result"), py::arg("cubes_map"),
          "Relative gap between session VWAP and TWAP (mean close).");
}
