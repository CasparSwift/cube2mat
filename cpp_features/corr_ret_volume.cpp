...
void cube2mat_corr_ret_volume(py::array_t<float, py::array::c_style | py::array::forcecast>& result,
...
void bind_cube2mat_corr_ret_volume(py::module& m){
    m.def("cube2mat_corr_ret_volume", &cube2mat_corr_ret_volume,
          py::arg("result"), py::arg("cubes_map"),
          "Correlation of signed log returns and volume within RTH.");
}
