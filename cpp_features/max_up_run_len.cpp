...
void cube2mat_max_up_run_len(py::array_t<float, py::array::c_style | py::array::forcecast>& result,
...
void bind_cube2mat_max_up_run_len(py::module& m) {
    m.def("cube2mat_max_up_run_len", &cube2mat_max_up_run_len,
          py::arg("result"), py::arg("cubes_map"),
          "Maximum consecutive length of positive-return run.");
}
