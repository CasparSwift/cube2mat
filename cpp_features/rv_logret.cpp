...
void cube2mat_rv_logret(py::array_t<float, py::array::c_style | py::array::forcecast>& result,
...
void bind_cube2mat_rv_logret(py::module& m){
    m.def("cube2mat_rv_logret", &cube2mat_rv_logret,
          py::arg("result"), py::arg("cubes_map"),
          "Realized variance using log returns: sum(diff(log(close))^2).");
}
