...
void cube2mat_volume_hhi(py::array_t<float, py::array::c_style | py::array::forcecast>& result,
...
void bind_cube2mat_volume_hhi(py::module& m){
    m.def("cube2mat_volume_hhi", &cube2mat_volume_hhi,
          py::arg("result"), py::arg("cubes_map"),
          "Herfindahl index of volume distribution across intraday bars.");
}
