...
void cube2mat_lower_shadow_ratio_mean(py::array_t<float, py::array::c_style | py::array::forcecast>& result,
...
void bind_cube2mat_lower_shadow_ratio_mean(py::module& m) {
    m.def("cube2mat_lower_shadow_ratio_mean", &cube2mat_lower_shadow_ratio_mean,
          py::arg("result"), py::arg("cubes_map"),
          "Mean lower shadow to range ratio for intraday candles.");
}
