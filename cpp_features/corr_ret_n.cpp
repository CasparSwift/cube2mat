...
void cube2mat_corr_ret_n(py::array_t<float, py::array::c_style | py::array::forcecast>& result,
...
void bind_cube2mat_corr_ret_n(py::module& m){
    m.def("cube2mat_corr_ret_n", &cube2mat_corr_ret_n,
          py::arg("result"), py::arg("cubes_map"),
          "Correlation of log returns and trade count n (RTH).");
}
