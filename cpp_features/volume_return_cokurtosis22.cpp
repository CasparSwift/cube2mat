...
void cube2mat_volume_return_cokurtosis22(py::array_t<float, py::array::c_style | py::array::forcecast>& result,
...
void bind_cube2mat_volume_return_cokurtosis22(py::module& m){
    m.def("cube2mat_volume_return_cokurtosis22", &cube2mat_volume_return_cokurtosis22,
          py::arg("result"), py::arg("cubes_map"),
          "Co-kurtosis(2,2) of volume and log returns in RTH");
}
