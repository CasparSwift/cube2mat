...
void cube2mat_variance_ratio_q2(py::array_t<float, py::array::c_style | py::array::forcecast>& result,
...
void bind_cube2mat_variance_ratio_q2(py::module& m){
    m.def("cube2mat_variance_ratio_q2", &cube2mat_variance_ratio_q2,
          py::arg("result"), py::arg("cubes_map"),
          "Variance Ratio of intraday log returns with q=2 in 09:30–15:59.");
}
