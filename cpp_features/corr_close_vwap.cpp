...
void cube2mat_corr_close_vwap(py::array_t<float, py::array::c_style | py::array::forcecast>& result,
...
void bind_cube2mat_corr_close_vwap(py::module& m){
    m.def("cube2mat_corr_close_vwap", &cube2mat_corr_close_vwap,
          py::arg("result"), py::arg("cubes_map"),
          "Correlation of close and vwap within RTH.");
}
