...
void cube2mat_vwap_cross_up_nextret(py::array_t<float, py::array::c_style | py::array::forcecast>& result,
...
void bind_cube2mat_vwap_cross_up_nextret(py::module& m) {
    m.def("cube2mat_vwap_cross_up_nextret", &cube2mat_vwap_cross_up_nextret,
          py::arg("result"), py::arg("cubes_map"),
          "Mean next return after upward VWAP crossing.");
}
