...
void cube2mat_partial_corr_absret_volume_time(py::array_t<float, py::array::c_style | py::array::forcecast>& result,
...
void bind_cube2mat_partial_corr_absret_volume_time(py::module& m) {
    m.def("cube2mat_partial_corr_absret_volume_time", &cube2mat_partial_corr_absret_volume_time,
          py::arg("result"), py::arg("cubes_map"),
          "Partial corr(|logret|, volume | time) within RTH.");
}
