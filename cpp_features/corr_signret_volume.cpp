...
void cube2mat_corr_signret_volume(py::array_t<float, py::array::c_style | py::array::forcecast>& result,
...
void bind_cube2mat_corr_signret_volume(py::module& m){
    m.def("cube2mat_corr_signret_volume", &cube2mat_corr_signret_volume,
          py::arg("result"), py::arg("cubes_map"),
          "Pearson correlation between sign(log-return) and volume within RTH.");
}
