...
void cube2mat_close_on_volume_beta(py::array_t<float, py::array::c_style | py::array::forcecast>& result,
...
void bind_cube2mat_close_on_volume_beta(py::module& m) {
    m.def("cube2mat_close_on_volume_beta", &cube2mat_close_on_volume_beta,
