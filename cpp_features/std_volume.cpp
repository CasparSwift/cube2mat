...
void cube2mat_std_volume(py::array_t<float, py::array::c_style | py::array::forcecast>& result,
...
void bind_cube2mat_std_volume(py::module& m) {
    m.def("cube2mat_std_volume", &cube2mat_std_volume,
          py::arg("result"), py::arg("cubes_map"),
          "Intraday volume std between 09:30–15:59; NaN if <3 ticks.");
}
