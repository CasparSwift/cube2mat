...
void cube2mat_post_std_close(py::array_t<float, py::array::c_style | py::array::forcecast>& result,
...
void bind_cube2mat_post_std_close(py::module& m){
    m.def("cube2mat_post_std_close", &cube2mat_post_std_close,
          py::arg("result"), py::arg("cubes_map"),
          "After-hours std(close) between 16:00–23:59; NaN if <3 ticks.");
}
