...
void cube2mat_std_trade_size(py::array_t<float, py::array::c_style | py::array::forcecast>& result,
...
void bind_cube2mat_std_trade_size(py::module& m){
    m.def("cube2mat_std_trade_size", &cube2mat_std_trade_size,
          py::arg("result"), py::arg("cubes_map"),
          "Std of per-bar average trade size");
}
