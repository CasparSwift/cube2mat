...
void cube2mat_rv_logret_30m(py::array_t<float, py::array::c_style | py::array::forcecast>& result,
    ...
    ssize_t step=static_cast<ssize_t>(std::llround(30.0/interval_min));
    if(step<1) step=1;
...
void bind_cube2mat_rv_logret_30m(py::module& m){
    m.def("cube2mat_rv_logret_30m", &cube2mat_rv_logret_30m,
          py::arg("result"), py::arg("cubes_map"),
          "Realized variance using log returns on 30-minute resampled close in 09:30–15:59.");
}
