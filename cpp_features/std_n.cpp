...
void cube2mat_std_n(py::array_t<float, py::array::c_style | py::array::forcecast>& result,
...
void bind_cube2mat_std_n(py::module& m) {
    m.def("cube2mat_std_n", &cube2mat_std_n,
          py::arg("result"), py::arg("cubes_map"),
          "Intraday std of trade count (n) between 09:30–15:59; NaN if <3 ticks.");
}
