...
void cube2mat_time_to_50pct_volume_frac(py::array_t<float, py::array::c_style | py::array::forcecast>& result,
...
void bind_cube2mat_time_to_50pct_volume_frac(py::module& m) {
    m.def("cube2mat_time_to_50pct_volume_frac", &cube2mat_time_to_50pct_volume_frac,
          py::arg("result"), py::arg("cubes_map"),
          "Session fraction to reach 50% of cumulative volume.");
}
