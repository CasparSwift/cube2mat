...
void cube2mat_vwap_dev_ar1_phi(py::array_t<float, py::array::c_style | py::array::forcecast>& result,
...
#pragma omp parallel for collapse(2)
    for(ssize_t i=0;i<d0;++i){
        for(ssize_t j=0;j<d1;++j){
            ...
            xm/=m; ym/=m; double num=0.0, den=0.0;
...
void bind_cube2mat_vwap_dev_ar1_phi(py::module& m){
    m.def("cube2mat_vwap_dev_ar1_phi", &cube2mat_vwap_dev_ar1_phi,
          py::arg("result"), py::arg("cubes_map"),
          "AR(1) phi of (close - vwap) deviation.");
}
