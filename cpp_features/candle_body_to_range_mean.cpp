...
void cube2mat_candle_body_to_range_mean(py::array_t<float, py::array::c_style | py::array::forcecast>& result,
...
void bind_cube2mat_candle_body_to_range_mean(py::module& m) {
    m.def("cube2mat_candle_body_to_range_mean", &cube2mat_candle_body_to_range_mean,
          py::arg("result"), py::arg("cubes_map"),
          "Mean of absolute body to range ratio for intraday candles.");
}
