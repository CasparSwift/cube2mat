...
void cube2mat_variance_ratio_q5(py::array_t<float, py::array::c_style | py::array::forcecast>& result,
...
void bind_cube2mat_variance_ratio_q5(py::module& m){
    m.def("cube2mat_variance_ratio_q5", &cube2mat_variance_ratio_q5,
          py::arg("result"), py::arg("cubes_map"),
          "Variance Ratio of intraday log returns with q=5 between 09:30–15:59.");
}
