...
void cube2mat_rv_cond_above_vwap(py::array_t<float, py::array::c_style | py::array::forcecast>& result,
...
void bind_cube2mat_rv_cond_above_vwap(py::module& m){
    m.def("cube2mat_rv_cond_above_vwap", &cube2mat_rv_cond_above_vwap,
          py::arg("result"), py::arg("cubes_map"),
          "Sum of r^2 (logret) while close>vwap within RTH.");
}
